        ...
        <div className="relative z-10 flex-1">
          ...
          <section className="flex min-h-[70vh] flex-col items-center justify-center px-4 py-20 text-center">
            ...
            >
              ...
              <motion.p
                className="text-2xl font-bold text-white drop-shadow-md md:text-3xl lg:text-4xl"
                variants={itemVariants}
              >
                Trade your conviction. <span className="text-[#C1FF72]">Draw your futures.</span>
              </motion.p>
              ...
              <motion.p
                ...
                variants={itemVariants}
              >
                A trading game where <strong className="text-[#C1FF72]">predictions are expressed as drawings</strong>, not orders.
