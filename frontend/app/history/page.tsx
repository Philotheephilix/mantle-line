    ...
    <div className="min-h-screen flex flex-col">
      ...
      <NoiseEffect opacity={0.6} className="flex-1 px-4 py-10">
        <div className="max-w-6xl mx-auto">
          ...
          {!isConnected && (
            <motion.div
              className="mb-8 p-6 rounded-xl border-4 border-[#C1FF72] bg-gradient-to-r from-[#1800AD]/80 to-[#0a0014]/80 shadow-[6px_6px_0_0_#C1FF72]"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            >
              <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-[#C1FF72]">Connect Your Wallet</h3>
            ...
            >
              {[
                ...
                >
                  ...
                  <div className={`text-2xl font-bold ${stat.label === 'Total PnL' && aggregatedStats.totalPnL < 0 ? 'text-red-400' : 'text-[#C1FF72]'}`}>
                    {stat.value}
                  </div>
                    ...
                    {sortedPositions.map((position) => {
                      ...
                      return (
                        <motion.div
                          ...
                          className={`grid grid-cols-1 md:grid-cols-12 gap-4 px-6 py-5 border-b border-[#C1FF72]/20 transition-all ${
                            hoveredPosition === position.positionId ? 'bg-[#1800AD]/40' : ''
                          }`}
                        ...
                        >
                          ...
                          <div className="md:hidden space-y-3">
                            <div className="flex items-center justify-between">
                              <div>
                                <div className="font-bold text-[#C1FF72]">Position #{position.positionId}</div>
                                <div className="text-xs text-white/50">{formatDate(position.closeTimestamp)}</div>
                              </div>
                              <div className="text-right">
                                <div className={`text-lg font-bold ${isPositive ? 'text-[#C1FF72]' : 'text-red-400'}`}>
                          ...
                          <div className="hidden md:contents">
                            ...
                            <div className="col-span-2 flex items-center justify-end">
                              <span className={`font-bold text-lg ${isPositive ? 'text-[#C1FF72]' : 'text-red-400'}`}>
                                {formatPnL(position.pnl)}
                              </span>
                            </div>
                            <div className="col-span-2 flex items-center justify-center">
            ...
            >
              <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                  <div className="text-5xl">📊</div>
                  <div>
                    <h3 className="text-xl font-bold text-[#C1FF72]">Your Statistics</h3>
