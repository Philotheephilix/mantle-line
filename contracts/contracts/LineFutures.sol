...
contract LineFutures {
    ...
    // Reference to MNTPriceOracle contract
    address public mntPriceOracle;
     ...
     * @param _mntPriceOracle Address of the MNTPriceOracle contract
     */
    constructor(address _pnlServer, address _mntPriceOracle) {
        require(_pnlServer != address(0), "LineFutures: PnL server is zero address");
        require(_mntPriceOracle != address(0), "LineFutures: oracle is zero address");
        
        owner = msg.sender;
        pnlServer = _pnlServer;
        mntPriceOracle = _mntPriceOracle;
